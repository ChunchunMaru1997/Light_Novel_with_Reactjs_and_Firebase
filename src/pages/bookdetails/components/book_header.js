...
const BookHeader = () => {
  ...
  const bookId = location.pathname.slice(6, location.pathname.length);
  console.log(bookId);
    ...
    <div>
      <div className="row">
        <div className="media col-sm-auto">
          <img
            src="https://static.cdnno.com/poster/y-tien-coc-lam-viec-vat-ba-muoi-nam-ta-bach-nhat-phi-thang/300.jpg?1619836876"
            alt="Y Tiên Cốc Làm Việc Vặt Ba Mươi Năm, Ta Bạch Nhật Phi Thăng"
          />
        </div>
        <div className="media-body col-sm">
          ...
          <ul className="list-unstyled mb-4">
            ...
            <li className="d-inline-block border border-danger px-3 py-1 text-danger rounded-pill m-2 mr-2 mb-2">
              {" "}
              Đang ra{" "}
            </li>
          </ul>
          <ul className="list-unstyled d-flex mb-4">
            ...
            <li style={{ marginRight: "30px" }}>
              <div className="font-weight-semibold h4 mb-1">5</div>
              <div>Chương/tuần</div>
            </li>
            <li style={{ marginRight: "30px" }}>
              <div className="font-weight-semibold h4 mb-1">497.6K</div>
              <div>Lượt đọc</div>
            </li>
            <li style={{ marginRight: "30px" }}>
              <div
                id="bookmarkedValue"
                className="font-weight-semibold h4 mb-1"
              >
                1150
              </div>
              <div>Cất giữ</div>
          ...
          <ul className="list-unstyled d-flex align-items-center">
            <li id="reading-book" className="m-2 w-150">
              <Link to={"chapter/1"}>
                ...
                >
                  <i className="nh-icon icon-glass mr-2" />
                  Đọc truyện{" "}
                </div>
              </Link>
            </li>
            <li id="bookmark" className="m-2 w-150">
              <span data-v-20fe2610>
                ...
                >
                  <i data-v-20fe2610 className="nh-icon icon-save mr-2" /> Đánh
                  dấu
                </a>
              </span>
            </li>
            <li id="suggest-book" className="m-2 w-150">
              <div data-v-5494eeb4>
                ...
                >
                  {/**/}{" "}
                  <i data-v-5494eeb4 className="svg-icon icon-flower mr-2" /> Đề
                  cử
                </a>{" "}
              </div>
            </li>
